...
const Display = ({info}) => {
  return (
    <div className='display absolute top-40 left-8 sm:left-12 md:left-14 lg:ml-10 flex text-center flex-col bg-white mt-5 px-5 w-5/6 py-5 font-Rubik rounded-2xl md:flex-row align-center justify-between sm:py-11 sm:px-9 2xl:justify-around 2xl:ml-14'>
        <div className='md:text-left md:pr-5  lg:border-r lg:border-gray-300'>
         ...
         <div className='mt-3 md:mt-0 md:text-left 2xl:mr-0 lg:border-r lg:border-gray-300'>
         ...
         <div className='mt-3 md:mt-0 md:text-left md:pr-5 2xl:mr-0 lg:border-r lg:border-gray-300'>
